 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "com.arun.example.jaxws.soap", wsdlLocation = "http://localhost:9992/personServer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("com.arun.example.jaxws.soap", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9992/personServer?wsdl");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("com.arun.example.jaxws.soap", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("com.arun.example.jaxws.soap", "PersonServiceImplPort"), PersonService.class, features);
    }
